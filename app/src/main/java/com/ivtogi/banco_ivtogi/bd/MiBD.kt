...
import com.ivtogi.banco_ivtogi.dao.ClienteDAO
import com.ivtogi.banco_ivtogi.dao.CuentaDAO
import com.ivtogi.banco_ivtogi.dao.MovimientoDAO
...
protected constructor(context: Context?) :
    ...
    private fun insercionDatos(db: SQLiteDatabase) {
        ...
        db.execSQL("INSERT INTO movimientos (rowid, id, tipo, fechaoperacion, descripcion, importe, idcuentaorigen, idcuentadestino) VALUES (null, null, 2, 1420153380000, 'Recibo Iberdrola Diciembre 2014', -96.36, 3, 5);")
        db.execSQL("INSERT INTO movimientos (rowid, id, tipo, fechaoperacion, descripcion, importe, idcuentaorigen, idcuentadestino) VALUES (null, null, 1, 1420153380000, 'Recibo Iberdrola Diciembre 2014', -84.84, 4, 5);")
        db.execSQL("INSERT INTO movimientos (rowid, id, tipo, fechaoperacion, descripcion, importe, idcuentaorigen, idcuentadestino) VALUES (null, null, 1, 1420326180000, 'Recibo Gas Natural Diciembre 2014', -340.39, 1, 6);")
        ...
        db.execSQL("INSERT INTO movimientos (rowid, id, tipo, fechaoperacion, descripcion, importe, idcuentaorigen, idcuentadestino) VALUES (null, null, 1, 1422831780000, 'Recibo Iberdrola Enero 2015', -95.34, 1, 5);")
        db.execSQL("INSERT INTO movimientos (rowid, id, tipo, fechaoperacion, descripcion, importe, idcuentaorigen, idcuentadestino) VALUES (null, null, 1, 1423004580000, 'Recibo Gas Natural Enero 2015', -65.34, 1, 6);")
        db.execSQL("INSERT INTO movimientos (rowid, id, tipo, fechaoperacion, descripcion, importe, idcuentaorigen, idcuentadestino) VALUES (null, null, 2, 1423090980000, 'Recibo BMW Enero 2015', -256.65, 1, 10);")
